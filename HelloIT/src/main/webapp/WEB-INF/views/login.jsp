	...
	<center>
		<div class="window" style="margin: 32px; width: 250px">
			...
			<div class="window-body">
				<h4>Please Login</h4>
				<input type="text" placeholder="ID :" /><br> <input
					type="password" placeholder="PW :" /><br> <br> <a
					href="">
					<button>Login</button>
				</a> <a href="">
					<button>Sign-in</button>
				</a> <br> <br> <a href="">회원이 아니신가요?</a> <br> <a href="">
					<img src="./img/google.png" id="google" width="50" alt="">
				</a> <a href=""> <img src="./img/naver.png" id="naver" width="50"
					alt=""></a> <a href=""> <img src="./img/kakao.png" id="kakao"
					width="50" alt=""></a>
				<p>소셜 계정으로 로그인</p>
				<%
