						...
						<ul class="links">
							<li><h5>로그인</h5></li>
								<form action="login.do" method="post">
									<li><input required type="text" name="email" placeholder="Email을 입력하세요"></li>
							...
							<section class="split">
								...
								<section>
									<div class="contact-method">
										...
										<%}else{%>
										<span><%=info.getU_activity_score()%></span>
										<%}%>
