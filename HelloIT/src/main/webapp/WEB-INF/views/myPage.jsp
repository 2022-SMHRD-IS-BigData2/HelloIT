	...
	<div class="container">
		<div class="wrapper">
			<div class="window"
				...
				<div class="title-bar" style="position: sticky; top: 1px">
					...
					<div class="title-bar-controls">
						<button aria-label="Close"
							onclick="location.href='goMain.do?u_email=<%=info.getU_email()%>'"></button>
					</div>
				</div>
				<div class="window-body" style="justify-content: space-between;">
					<div>
						<ul class="tree-view" style="font-family: auto;">
							...
							<li>
							<li id="listOfFAQ" style="cursor: pointer;">FAQ
							<li>
						</ul>
						
						
						<p class="status-bar-field">
							<b>팔로잉 : <%=request.getAttribute("followingCnt")%></b> <b>팔로워
								: <%=request.getAttribute("followerCnt")%></b>
						</p>
					</div>
						...
						<div id="myPage" style="display: none;">
							<div class="container">
								<div class="wrapper" style="position: sticky; top: 27px;">
									<div class="window"
										style="width: 400px; position: sticky; top: 0; max-width: 100%; width: 400px; display: block; margin: 0 100px; margin-bottom: 50px;"
										align="center">
										<div class="title-bar">
											<div class="title-bar-text">회원 정보</div>
											<div class="title-bar-controls">
												<button aria-label="Close"
													onclick="location.href ='goMyPage.do?u_email=<%=info.getU_email()%>'"></button>
											</div>
										</div>
										<form action="" method="post"
											style="margin: 20px; font-size: initial">
											<table class="userInfo">
												<tbody>
													...
													<tr>
														<td>현재비밀번호</td>
														<td style="padding-left: 4px"><input type="password"
															name="pw1" placeholder="현재 비밀번호 입력"></td>
													</tr>
													<tr>
														<td>변경할 비밀번호</td>
														<td style="padding-left: 4px"><input type="password"
															name="repw2" placeholder="변경할 비밀번호 입력"></td>
													</tr>
													<tr>
														<td>변경할 비밀번호 확인</td>
														<td style="padding-left: 4px"><input type="password"
															name="repw3" placeholder="변경할 비밀번호 확인"></td>
													</tr>
													<tr>
														<td>생년월일</td>
											...
											<br>
											<div>
												<input type="submit" onclick="myInfoPopup();" value="저장">
											</div>
										</form>
									</div>
								</div>
						...
						<div class="window" id="checkInterest"
							...
							<div class="window-body" style="display: block;">
								<p style="font-size: large; font-weight: bold;">
									관심있는분야나 직장에서 맡고있는 분야를 선택하세요<sub>(중복선택 가능)</sub>
								</p>
								<p style="font-size: small; font-weight: bold;">체크한 분야에 따라서
									게시물이 자동 선별됩니다.</p>
								<br>
								<form action="userLevelSetting.do" method="post">
									<input type="hidden" name="u_email"
										value="<%=info.getU_email()%>">
										...
										<tr class="interest" id="userRole">
											...
											<td
												...
												<div style="text-align: end; margin: 0 5px">
													<div>
														프론트엔드 <select name="frontend_level" id="frontend_level">
													...
													<div>
														백엔드 <select name="backend_level" id="backend_level">
															<option value="1">예비개발자(학생)</option>
															<option value="2">사원(주니어)</option>
															<option value="3">대리(미드레벨)</option>
															<option value="4">과장~부장(시니어)</option>
												...
												<div style="text-align: end; margin: 0 5px">
													<div>
														데이터 <select name="data_level" id="data_level">
															<option value="1">예비개발자(학생)</option>
															<option value="2">사원(주니어)</option>
															<option value="3">대리(미드레벨)</option>
															<option value="4">과장~부장(시니어)</option>
													...
													<div>
														기타 <select name="etc_level" id="etc_level">
															<option value="1">예비개발자(학생)</option>
															<option value="2">사원(주니어)</option>
															<option value="3">대리(미드레벨)</option>
															<option value="4">과장~부장(시니어)</option>
											...
											<td><input type="submit" onclick="levelPopup();"
												value="저장"> <input type="reset" value="초기화">
											</td>
										</tr>
									</table>
								</form>
								<form action="updateRole.do" method="post">
									<table>
										<tr class="interest" id="userRole">
											<td><h4>역할</h4></td>
											<td><input type="checkbox" name="frontend" id="frontend"
												value="Y"> <label for="frontend">프론트엔드</label> <input
												type="checkbox" name="backend" id="backend" value="Y">
												<label for="backend">백엔드</label> <input type="checkbox"
												name="data_etc" id="data_etc" value="Y"> <label
												for="data_etc">데이터분야(빅데이터,인공지능포함)</label> <input
												type="checkbox" name="other_skill" id="other_skill"
												value="Y"> <label for="other_skill">기타</label> <br>
												...
												id="other_skill_hidden" value="N"></td>
											<td><input type="submit" onclick="rolePopup();"
												value="저장"> <input type="reset" value="초기화">
											</td>
										</tr>
									</table>
								...
								<form action="updateSkill.do" method="post">
									<table>
										<tr class="interest" id="userSkill">
											<td><h4>분야</h4></td>
											<td><input type="checkbox" name="web" id="web" value="Y">
												<label for="web">웹</label> <input type="checkbox" name="ios"
												id="ios" value="Y"> <label for="ios">iOS</label> <input
												...
												<label for="skill_etc">기타</label> <br> <br> <input
												type="hidden" name="u_email" value="<%=info.getU_email()%>">
												<input type="hidden" name="web" id="web_hidden" value="N">
												<input type="hidden" name="ios" id="ios_hidden" value="N">
												<input type="hidden" name="android" id="android_hidden"
												value="N"> <input type="hidden" name="windows"
												id="windows_hidden" value="N"> <input type="hidden"
												name="mac" id="mac_hidden" value="N"> <input
												type="hidden" name="linux" id="linux_hidden" value="N">
												<input type="hidden" name="game" id="game_hidden" value="N">
												<input type="hidden" name="skill_etc" id="skill_etc_hidden"
												value="N"></td>
											<td><input type="submit" onclick="skillPopup();"
												value="저장"> <input type="reset" value="초기화">
											</td>
										</tr>
									</table>
								...
								<form action="updateLanguage.do" method="post">
									<table>
										<tr class="interest" id="userLanguage">
											<td><h4>언어</h4></td>
											<td><input type="checkbox" name="html" id="html"
												value="Y"> <label for="html">HTML</label> <input
												type="checkbox" name="css" id="css" value="Y"> <label
												for="css">CSS</label> <input type="checkbox" name="c" id="c"
												value="Y"> <label for="c">C</label> <input
												type="checkbox" name="c_pp" id="c_pp" value="Y"> <label
												for="c_pp">C++</label> <input type="checkbox" name="c_sharp"
												id="c_sharp" value="Y"> <label for="c_sharp">C#</label>
												<input type="checkbox" name="java" id="java" value="Y">
												<label for="java">JAVA</label> <input type="checkbox"
												name="python" id="python" value="Y"> <label
												for="python">Python</label> <input type="checkbox"
												...
												name="r" id="r" value="Y"> <label for="r">R</label>
												<input type="checkbox" name="ruby" id="ruby" value="Y">
												<label for="ruby">Ruby</label> <input type="checkbox"
												name="haskell" id="haskell" value="Y"> <label
												for="haskell">Haskell</label> <input type="checkbox"
												name="clojure" id="clojure" value="Y"> <label
												for="clojure">Clojure</label> <input type="checkbox"
												...
												type="hidden" name="css" id="css_hidden" value="N">
												<input type="hidden" name="c" id="c_hidden" value="N">
												<input type="hidden" name="c_pp" id="c_pp_hidden" value="N">
												<input type="hidden" name="c_sharp" id="c_sharp_hidden"
												value="N"> <input type="hidden" name="java"
												id="java_hidden" value="N"> <input type="hidden"
												name="python" id="python_hidden" value="N"> <input
												type="hidden" name="php" id="php_hidden" value="N">
												<input type="hidden" name="dart" id="dart_hidden" value="N">
												<input type="hidden" name="typescript"
												id="typescript_hidden" value="N"> <input
												type="hidden" name="kotlin" id="kotlin_hidden" value="N">
												<input type="hidden" name="go" id="go_hidden" value="N">
												<input type="hidden" name="rust" id="rust_hidden" value="N">
												<input type="hidden" name="swift" id="swift_hidden"
												value="N"> <input type="hidden" name="scala"
												id="scala_hidden" value="N"> <input type="hidden"
												name="objective_c" id="objective_c_hidden" value="N">
												<input type="hidden" name="r" id="r_hidden" value="N">
												<input type="hidden" name="ruby" id="ruby_hidden" value="N">
												<input type="hidden" name="haskell" id="haskell_hidden"
												value="N"> <input type="hidden" name="clojure"
												id="clojure" value="N"> <input type="hidden"
												name="sql" id="sql_hidden" value="N"> <input
												type="hidden" name="language_etc" id="language_etc_hidden"
												value="N"></td>
											<td><input type="submit" onclick="langPopup();"
												value="저장"> <input type="reset" value="초기화">
											</td>
										</tr>
									</table>
								...
								<form action="updateDB.do" method="post">
									<table>
										<tr class="interest" id="userDB">
											<td><h4>DB</h4></td>
											<td><input type="checkbox" name="mysql" id="mysql"
												value="Y"> <label for="mysql">MySQL</label> <input
												type="checkbox" name="oracle" id="oracle" value="Y">
												...
												name="redis" id="redis" value="Y"> <label
												for="redis">Redis</label> <input type="checkbox"
												name="sqlite" id="sqlite" value="Y"> <label
												for="sqlite">SQLite</label> <input type="checkbox"
												...
												<label for="dynamodb">DynamoDB</label> <input
												type="checkbox" name="firebase" id="firebase" value="Y">
												<label for="firebase">Firebase</label> <input
												type="checkbox" name="tibero" id="tibero" value="Y">
												<label for="tibero">Tibero</label> <input type="checkbox"
												name="hive" id="hive" value="Y"> <label for="hive">Hive</label>
												<input type="checkbox" name="cassandra" id="cassandra"
												value="Y"> <label for="cassandra">Cassandra</label>
												<input type="checkbox" name="db_etc" id="db_etc" value="Y">
												<label for="db_etc">기타</label> <br> <br> <input
												type="hidden" name="u_email" value="<%=info.getU_email()%>">
												<input type="hidden" name="mysql" id="mysql_hidden"
												value="N"> <input type="hidden" name="oracle"
												id="oracle_hidden" value="N"> <input type="hidden"
												name="mariadb" id="mariadb_hidden" value="N"> <input
												type="hidden" name="pstgresql" id="pstgresql_hidden"
												value="N"> <input type="hidden" name="mongodb"
												id="mongodb_hidden" value="N"> <input type="hidden"
												name="redis" id="redis" value="N"> <input
												type="hidden" name="sqlite" id="sqlite_hidden" value="N">
												<input type="hidden" name="aws_aurora"
												id="aws_aurora_hidden" value="N"> <input
												type="hidden" name="elasticsearch" id="elasticsearch_hidden"
												value="N"> <input type="hidden" name="dynamodb"
												id="dynamodb_hidden" value="N"> <input type="hidden"
												name="firebase" id="firebase_hidden" value="N"> <input
												type="hidden" name="tibero" id="tibero_hidden" value="N">
												<input type="hidden" name="hive" id="hive_hidden" value="N">
												<input type="hidden" name="cassandra" id="cassandra_hidden"
												value="N"> <input type="hidden" name="db_etc"
												id="db_etc_hidden" value="N"></td>
											<td><input type="submit" onclick="dbPopup();" value="저장">
						...
						<div id="posted">
							...
							<div id="checkPost" class="window posted" style="width: 630px">
									...
									<table id="list" border="1" bgcolor="white">
										...
										<tr>
											<td colspan="2" align="center"><img alt=""
												src="img/<%=upList.get(i).getPost_file()%>"><br>
												<br> <b><%=upList.get(i).getPost_content()%></b></td>
										</tr>
										<%
										...
										<tr style="height: 20px">
											<td colspan="2">
												...
												%> <a
												href="goTagMain.do?tag_seq=<%=list2.get(k).getTag_seq()%>"><%='#' + list2.get(k).getTag_content()%></a>
												<%
												} ;
												%>
											</td>
								...
								<div class="status-bar">
									<p class="status-bar-field">
										<a
											href="mainBookmark.do?req_page=myPage&post_seq=<%=upList.get(i).getPost_seq()%>
					&u_email=<%=info.getU_email()%>">
									...
									<p class="status-bar-field">
										<a
											href="mainLike.do?req_page=myPage&post_seq=<%=upList.get(i).getPost_seq()%>&u_email=<%=info.getU_email()%>">
									...
									<form action="mainCmt.do">
										<input type="hidden" name="req_page" value="myPage"> <input
											type="hidden" name="post_seq"
											value="<%=upList.get(i).getPost_seq()%>"> <input
											type="hidden" name="u_email" value="<%=info.getU_email()%>">
										<p class="status-bar-field">
											<input type="text" name="cmt_content" placeholder="댓글"
												style="width: 290px"> <input type="submit"
												value="등록">
										</p>
									</form>
								...
								<table style="width: 630px;">
									<tr>
										...
										<td><a
											href="mainCmtLike.do?req_page=myPage&cmt_seq=<%=cmtList.get(j).getCmt_seq()%>&u_email=<%=info.getU_email()%>">
							...
							<div id="checkPost" class="window posted" style="width: 630px">
								...
								<div class="window-body">
									<table id="list" border="1" bgcolor="white">
										...
										<tr>
											<td colspan="2" align="center"><img alt=""
												src="img/<%=bmList.get(i).getPost_file()%>"><br>
												<br> <b><%=bmList.get(i).getPost_content()%></b></td>
										</tr>
										<%
										PostInfoDAO daoTag = new PostInfoDAO();
								...
								<div class="status-bar">
									<p class="status-bar-field">
										<a
											href="mainBookmark.do?req_page=myPage&post_seq=<%=bmList.get(i).getPost_seq()%>
					&u_email=<%=info.getU_email()%>">
											<button id="btn">
									...
									<p class="status-bar-field">
										<a
											href="mainLike.do?req_page=myPage&post_seq=<%=bmList.get(i).getPost_seq()%>&u_email=<%=info.getU_email()%>">
									...
									<form action="mainCmt.do">
										<input type="hidden" name="req_page" value="myPage"> <input
											type="hidden" name="post_seq"
											value="<%=bmList.get(i).getPost_seq()%>"> <input
											type="hidden" name="u_email" value="<%=info.getU_email()%>">
										<p class="status-bar-field">
											<input type="text" name="cmt_content" placeholder="댓글"
												style="width: 290px"> <input type="submit"
									...
									<div>
										<div>
											<table>
												...
												<tr>
													<td><input type="text" placeholder="아이디를 검색하세요"
										...
										<!-- ul태그 추가한거 -->
											...
											<div id="tab-1" style="margin-bottom: 50px" class="tab-content current">
												<div id="follow-table">
													<table
														style="width: 600px; height: 100px; overflow: auto; text-align: center;">
														<thead>
															<tr height="30px">
																<th>아이디</th>
																<th>메신저보내기</th>
														...
														<tbody>
															...
															<tr>
																...
																<td><a href="#"><img src="img/message.png"
																		alt="메세지보내기"></img></a></td>
																<td><a
																	href="follow.do?follower_email=<%=info.getU_email()%>&u_email=<%=following.get(i).getU_email()%>">
																		<button id="btn">삭제</button>
																</a> <!-- <img src="img/delete.png" width="50px"
														...
														<tbody id="follower">
															...
															<tr>
																...
																<td><a href="#"><img src="img/message.png"
																		alt="메세지보내기"></img></a></td>
																<td><a
																	href="follow.do?follower_email=<%=info.getU_email()%>&u_email=<%=follower.get(i).getU_email()%>">
																		<button id="btn">팔로잉</button>
																</a> <!-- <img src="img/delete.png" width="50px"
													height="50px" alt="팔로워 삭제" onclick="test()"> --></td>
															</tr>
															<%
						...
						<a href="goIdea.do?num=<%=cnt.size()%>" class="bt">Next ＞＞</a>
									...
									<div id="portfolio" style="display: none;">
										<div class="window"
											style="width: 400px; display: block; margin: 0 100px; margin-bottom: 50px;">
											<div class="title-bar">
											...
											<form>
												<table class="userInfo">
													<tbody>
														...
														<tr>
															...
															<td colspan="2"><textarea name="talk" cols="50"
																	rows="5"></textarea></td>
														</tr>
												...
												<br> <input type="submit" onclick="pfPopup();"
													value="이력서 저장하기">
											</form>
										</div>
									</div>
									...
									<div id="faq" style="display: none;">
										<div class="window" style="width: 630px; margin-bottom: 40px"
											align="center">
											...
											<br> <br> <img src="./img/window.gif" width="200"
												alt="">
											<h3>자주 묻는 질문</h3>
											<div class="faq-container">
												<div class="faq">
													...
													<p class="faq-text">안녕하세요 이용자님 "Hello it"은 국내 모든 개발자들을
														위한 SNS로 개발관련 정보공유를 보다 손쉽게 캐치 하실 수 있으십니다.</p>
												...
												<div class="faq">
													...
													<p class="faq-text">여러분들의 머리속에 있는 프로젝트 주제를 등록 할수 있으면서
														동시에 그 주제에 대해 다른 사용자 분들과 토론이 진행가능 하며 채용자들의 스카우트 대상이 될수도
														있어요!</p>
												...
												<div class="faq">
													...
													<p class="faq-text">네 당연합니다! 우리 Hello it은 개인 역량에 맞춰
														언어별로 자신에게 맞는 눈높이로 정보들을 습득할 수 있습니다.</p>
												...
												<div class="faq">
													...
													<p class="faq-text">
														여기로 모시겠습니다! <br> <br> <a href="goDevInfo.do"><img
															src="./img/KakaoTalk_20221207_141006268.png" width="100"
															alt=""></a>
													</p>
													<button class="faq-toggle">
														<i class="fas fa-chevron-down"></i> <i
						...
						<footer class="main_footer">
							<div class="window icons" style="width: 800px" align="center">
								<a href="goPopPostMain.do" title="인기게시물"><img
									src="./img/dfsfg.png" id="fire" width="50" alt=""></a> <a
									href="goIdea.do" title="아이디어토론방"><img src="./img/123.png"
									id="idea" width="40" alt=""></a> <a
									href="goMain.do?u_email=<%=info.getU_email()%>" title="맞춤게시물"><img
									src="./img/dff.gif" id="goMain" width="50" alt="error"></a> <a
									href="goMainWrite.do" title="글쓰기"><img
									src="./img/dfsee.gif" id="goMain" width="41" alt="error"></a>
								<a href="goRecruit.do" title="채용공고게시판"><img
									src="./img/xml-0.png" id="job" width="40" alt=""></a> <a
									href="goMyPage.do?u_email=<%=info.getU_email()%>" title="마이페이지"><img
									src="./img/icon_15.png" id="my_page" width="40" alt=""></a> <a
									href="goMessage.do" title="메시지"><img
									src="./img/sfsdffd.png" id="message" alt="" width="30"></a>
							</div>
						</footer>
					</div>
				</div>
				...
				<script>
					// 역할 관련
					var frontend_hidden = $("#frontend").prop("checked") ? "Y"
							: "N";
					$("#frontend_hidden").val(frontend_hidden);
					var backend_hidden = $("#backend").prop("checked") ? "Y"
							: "N";
					$("#backend_hidden").val(backend_hidden);
					var data_etc_hidden = $("#data_etc").prop("checked") ? "Y"
							: "N";
					$("#data_etc_hidden").val(data_etc_hidden);
					var other_skill_hidden = $("#other_skill").prop("checked") ? "Y"
							: "N";
					...
					var android_hidden = $("#android").prop("checked") ? "Y"
							: "N";
					$("#android_hidden").val(android_hidden);
					var windows_hidden = $("#windows").prop("checked") ? "Y"
							: "N";
					...
					var skill_etc_hidden = $("#skill_etc").prop("checked") ? "Y"
							: "N";
					...
					var javascript_hidden = $("#javascript").prop("checked") ? "Y"
							: "N";
					...
					var typescript_hidden = $("#typescript").prop("checked") ? "Y"
							: "N";
					$("#typescript_hidden").val(typescript_hidden);
					var kotlin_hidden = $("#kotlin").prop("checked") ? "Y"
							: "N";
					...
					var objective_c_hidden = $("#objective_c").prop("checked") ? "Y"
							: "N";
					...
					var oracle_hidden = $("#oracle").prop("checked") ? "Y"
							: "N";
					$("#oracle_hidden").val(oracle_hidden);
					var mariadb_hidden = $("#mariadb").prop("checked") ? "Y"
							: "N";
					$("#mariadb_hidden").val(mariadb_hidden);
					var pstgresql_hidden = $("#pstgresql").prop("checked") ? "Y"
							: "N";
					$("#pstgresql_hidden").val(pstgresql_hidden);
					var mongodb_hidden = $("#mongodb").prop("checked") ? "Y"
							: "N";
					$("#mongodb_hidden").val(mongodb_hidden);
					var redis = $("#redis").prop("checked") ? "Y" : "N";
					$("#redis").val(redis);
					var sqlite_hidden = $("#sqlite").prop("checked") ? "Y"
							: "N";
					$("#sqlite_hidden").val(sqlite_hidden);
					var aws_aurora_hidden = $("#aws_aurora").prop("checked") ? "Y"
							: "N";
					$("#aws_aurora_hidden").val(aws_aurora_hidden);
					var elasticsearch_hidden = $("#elasticsearch").prop(
							"checked") ? "Y" : "N";
					$("#elasticsearch_hidden").val(elasticsearch_hidden);
					var dynamodb_hidden = $("#dynamodb").prop("checked") ? "Y"
							: "N";
					$("#dynamodb_hidden").val(dynamodb_hidden);
					var firebase_hidden = $("#firebase").prop("checked") ? "Y"
							: "N";
					$("#firebase_hidden").val(firebase_hidden);
					var tibero_hidden = $("#tibero").prop("checked") ? "Y"
							: "N";
					$("#tibero_hidden").val(tibero_hidden);
					var hive_hidden = $("#hive").prop("checked") ? "Y" : "N";
					$("#hive_hidden").val(hive_hidden);
					var cassandra_hidden = $("#cassandra").prop("checked") ? "Y"
							: "N";
					$("#cassandra_hidden").val(cassandra_hidden);
					var db_etc_hidden = $("#db_etc").prop("checked") ? "Y"
							: "N";
