...
<body>
	...
	UserInfo pageInfo = (UserInfo)session.getAttribute("pageInfo");
	...
	<div class="container">
		<div class="wrapper">
			<div class="window" style="width: 800px; position: sticky; top: 0; max-width:100%"align="center">
		 	...
		 	<div class="window-body" style="justify-content: space-between;">
			 	...
			 	<ul class="tree-view" style="font-family:auto;">
					  ...
					  <li id="listOfMyIdea" style="cursor:pointer;">아이디어<li>
				...
				<p class="status-bar-field">
					...
					<br>
					<a href="follow.do?follower_email=<%=info.getU_email()%>&u_email=<%=pageInfo.getU_email()%>">
					<button	id="btn"> 팔로우
					</button></a>
				</p>
				</div>
		                    ...
		                    <form style="margin:20px; font-size:initial">
		                        <table class="userInfo">
		                            ...
		                            <tr>
		                                ...
		                                <td style="padding-left:4px"><%=pageInfo.getU_email() %></td>
		                            </tr>
		                            <tr>
		                                <td>이름</td>
		                                <td style="padding-left:4px"><%=pageInfo.getU_name() %></td>
		                            </tr>
		                            <tr>
		                                <td>닉네임</td>
		                                <td style="padding-left:4px"><%=pageInfo.getU_nick() %></td>
		                            </tr>
		                            <tr>
		                                <td>현재비밀번호</td>
		                            ...
		                            <tr>
		                                <td>생년월일</td>
		                                <td style="padding-left:4px"><%=pageInfo.getU_birthdate()%></td>
		                            </tr>
		                            <tr>
		                                <td>직업</td>
		                                <td style="padding-left:4px"><%=pageInfo.getU_job() %></td>
		                            </tr>
		                            <tr>
		                                <td>활동점수</td>
		                                <td style="padding-left:4px"><%=pageInfo.getU_activity_score() %></td>
		                            </tr>
		                            </tbody>
		                        </table>
		                        <br>
			...
			<div class="window-body">
				<table id="list" border="1" bgcolor="white">
					<tr>
						<td>작성자</td>
						<td style="width: 650px"><a href="goUserPage.do?u_email=<%=upList.get(i).getU_email()%>"><%=upList.get(i).getU_name()%></a></td>
					</tr>
					<tr>
						<td colspan="2">내용</td>
					</tr>
			...
			<div class="status-bar">
				<p class="status-bar-field">
					<a href="mainBookmark.do?page_email=<%=pageInfo.getU_email()%>&req_page=userPage&post_seq=<%=upList.get(i).getPost_seq()%>
				...
				<%-- 좋아요 기능 --%>
				<p class="status-bar-field">
					<a href="mainLike.do?req_page=userPage&page_email=<%=pageInfo.getU_email()%>&post_seq=<%=upList.get(i).getPost_seq()%>&u_email=<%=info.getU_email()%>">
					<button	id="btn"><%=upList.get(i).getLikes()%> 💖
					</button></a>
				</p>
				<%-- 좋아요 기능 끝 --%>
				<form action="mainCmt.do">
					<input type="hidden" name="page_email" value="<%=pageInfo.getU_email()%>">
					<input type="hidden" name="req_page" value="userPage">
	    ...
	    <div id="bookmark">
			...
			<div class="status-bar">
				<p class="status-bar-field">
					<a href="mainBookmark.do?page_email=<%=pageInfo.getU_email()%>&req_page=userPage&post_seq=<%=bmList.get(i).getPost_seq()%>
					&u_email=<%=info.getU_email()%>">
					<button	id="btn">
				...
				<%-- 좋아요 기능 --%>
				<p class="status-bar-field">
					<a href="mainLike.do?page_email=<%=pageInfo.getU_email()%>&req_page=userPage&post_seq=<%=bmList.get(i).getPost_seq()%>&u_email=<%=info.getU_email()%>">
