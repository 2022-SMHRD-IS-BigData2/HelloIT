				...
				<form action="write.do" method="post" enctype="multipart/form-data" style="margin-bottom:5px">
					...
					<div class="window-body"
						...
						<div class="field-row-stacked"
							style="width: 575px; flex-direction: row;">
							<span
								style="width: 30px; text-align: center; font-size: larger; font-weight: bold;">주제</span>
							<input id="text18" type="text" name="post_title"
								style="margin-left: 10px; margin-top: 0; margin-bottom: 0; width: 535px">
						</div>
						<br>
					</div>
					...
					<div class="field-row-stacked" style="width: 700px">
						...
						<textarea id="text20" rows="8" style="height: 550px;"
						...
						<div class="tr_hashTag_area">
							...
							<div class="form-group">
								<input type="text" id="tag" size="7"
									placeholder="스페이스바로 해시태그를 등록해주세요." style="width: 500px;" />
							</div>
												...
												if (e.key === "SPACE BAR"
													...
													if (tagValue !== "") {
														...
														if (result.length == 0) {
															...
															$("div.tag")
																	.append(
																			'<input type="hidden" name="tag_content" value="'+tagValue+'">');
